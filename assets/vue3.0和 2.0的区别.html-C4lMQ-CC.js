import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,d as e}from"./app-DdiZsM7o.js";const i={},l=e(`<h1 id="vue2-和-vue3区别" tabindex="-1"><a class="header-anchor" href="#vue2-和-vue3区别"><span>vue2 和 vue3区别</span></a></h1><h3 id="生命周期的变化" tabindex="-1"><a class="header-anchor" href="#生命周期的变化"><span>生命周期的变化</span></a></h3><p>整体来看，变化不大，只是名字大部分需要 + <code>on</code>，功能上类似。使用上 Vue3 组合式 API 需要先引入；Vue2 选项 API 则可直接调用，如下所示。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>// vue3</span></span>
