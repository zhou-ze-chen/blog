import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as i}from"./app-DdiZsM7o.js";const e={},l=i(`<h1 id="动态组件详解" tabindex="-1"><a class="header-anchor" href="#动态组件详解"><span>动态组件详解</span></a></h1><h5 id="_1、-什么是动态组件" tabindex="-1"><a class="header-anchor" href="#_1、-什么是动态组件"><span>1、 什么是动态组件</span></a></h5><p>动态组件是指：在一个挂载点使用多个组件，并进行动态切换。可能对于新手来说，这句话有些难理解，什么是挂载点? 可以简单的理解为页面的一个位置。<br> 最常见的就是：tab 的切换功能。</p><p>在 vue 要实现这个功能通常用两种方式。一是使用<code>&lt;component&gt;</code>元素的 <strong>is</strong> 的特性，二是使用 <strong>v-if</strong> 。</p><h4 id="方式一" tabindex="-1"><a class="header-anchor" href="#方式一"><span>方式一：</span></a></h4><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
